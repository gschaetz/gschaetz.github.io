...
import { Github, Linkedin, Twitter, Mail, Facebook, X } from 'lucide-react';

const Footer = () => {
  const socialLinks = [
    { icon: Github, href: 'https://github.com/gschaetz', label: 'GitHub' },
    // { icon: Linkedin, href: '#', label: 'LinkedIn' },
    // { icon: X, href: '#', label: 'Twitter' },
    { icon: Facebook, href: 'https://www.facebook.com/profile.php?id=100068169760566', label: 'Facebook' },
    { icon: Mail, href: 'mailto:apps@schaetzkc.com', label: 'Email' },
  ];
